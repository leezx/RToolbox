...
draw_single_merged_barplot_go <- function(barplot_df) {
  library(Hmisc)
  library(stringr)
  # barplot_df <- up_neurongenesis
  # barplot_df <- intermediate
...
## venn plot
venn_plot <- function(data, method=c("online", "gplots::venn", "venneuler", "VennDiagram")) {
  if (method=="gplots::venn") {
